...
#define SVRetinaOnlyImage(base) ([self imageWithBytesNoCopy:(void *)(base) length:sizeof(base) scale:2.0])
...
+ (UIImage *)angleMask {
    return SVRetinaOnlyImage(angleMask2x);
}

+ (UIImage *)infoImage {
    return SVRetinaOnlyImage(info2x);
}

+ (UIImage *)successImage {
    return SVRetinaOnlyImage(success2x);
}

+ (UIImage *)errorImage {
    return SVRetinaOnlyImage(error2x);
}
